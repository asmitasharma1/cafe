  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        console.error("[v0] Contact form submission failed:", result.error);
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 font-sans">
      ...
      <main>
        ...
        >
          ...
          <div className="relative z-10 text-center text-white max-w-2xl mx-auto px-4 md:px-6">
            <div className="bg-black/20 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-white/20 shadow-2xl">
              ...
              <p className="text-sm md:text-lg font-light px-2 text-gray-200">
        ...
        <div className="py-4 md:py-6 px-4 md:px-6 bg-[#f5e9db]">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8">
              <div className="space-y-4 text-[#67322C] text-center md:text-left">
              ...
              <div className="w-50">
                <img
                  src="/coffeepng.png"
                  alt="Café Cucina"
                  className="w-full h-[200px] object-cover rounded-lg md:h-[250px]"
                />
              </div>
            </div>
          </div>
        ...
        {/* Map Section */}
        <div className="py-4 md:py-4 px-4 md:px-6 bg-[#f5e9db]">
