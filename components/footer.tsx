...
export default function Footer() {
    return (
        <footer className="bg-[#ebb16d] py-8 px-6">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-center items-center gap-60">
                {/* Logo */}
                <div className="flex items-center">
                    <div className="rounded-full flex items-center justify-center border-0 border-[#ebb16d]">
                        <img
                            src="/footerlogo.png"
                            alt="Café & Cucina Logo"
                ...
                <div className="flex flex-col md:flex-row justify-center w-full md:w-auto gap-12 text-white">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <ul className="space-y-2 flex flex-col items-center md:items-start">
                            ...
                            <li><Facebook className="w-6 h-6" /></li>
                            <li><Phone className="w-6 h-6" /></li>
                        </ul>
                    </div>
                </div>
            </div>
